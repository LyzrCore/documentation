...
```http
POST https://v1.api.data-analyzr.dev.app.lyzr.ai/v1/rag-vector-store/update-rag-vector-store-postgres
```

Update the vector store for use in analysis with a PostgreSQL database.
...
url = "https://v1.api.data-analyzr.dev.app.lyzr.ai/v1/rag-vector-store/update-rag-vector-store-postgres"
