...
2. [**Build an agent**](https://docs.lyzr.ai/agent-studio/agent-building)**:** Agents can be built using Lyzr Agent Studio or through APIs. Agent Studio provides you a easy no-code way to build agents.&#x20;

<Accordion title="Components of an Agent" defaultOpen={true}>
  * [Models](https://docs.lyzr.ai/agent-studio/models)

  * [Knowledge base](https://docs.lyzr.ai/agent-studio/knowledge-base)

  * [Tools](https://docs.lyzr.ai/agent-studio/tools)
</Accordion>

1. [Deploy your agent](https://docs.lyzr.ai/agent-studio/publishing_deployment): Agent built can be either published as part of Lyzr Agent Marketplace, or can be deployed externally as part of your product through Lyzr API

2. **Purchase a plan & build more agents:** Choose the right plan as per your requirements.