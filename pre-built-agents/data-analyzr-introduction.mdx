...
DataAnalyzr – your go-to tool for seamless and comprehensive data analysis. DataAnalyzr is an innovative conversational analytics framework that provides access to LLM-integrated advanced data analysis through a conversational interface to derive actionable insights and intuitive visualizations.
...
DataAnalyzr supports both [pythonic](/pre-built-agents/data-analysis-agent) and [SQL-based analysis](/pre-built-agents/text-sql-agent), allowing you to choose the best approach for your data analysis needs.
