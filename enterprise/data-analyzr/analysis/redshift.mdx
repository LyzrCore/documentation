---
title: Amazon Redshift Analysis
sidebarTitle: Amazon Redshift
---

```http
POST https://v1.api.data-analyzr.dev.app.lyzr.ai/v1/data_analyzer/sync/get-analysis-from-redshift
```

Get data analysis results for an Amazon Redshift database.
...
<ParamField path='redshift_config' type='dictionary' required>
...
url = "https://v1.api.data-analyzr.dev.app.lyzr.ai/v1/data_analyzer/sync/get-analysis-from-redshift"
